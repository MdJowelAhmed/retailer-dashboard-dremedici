...
const [subscriptionPlans, setSubscriptionPlans] = useState([
  {
    ...
    buttonColor: "#379683", // Enhanced Silver color (darker shade)
    benefits: [
      "Free Shipping – Included with subscription orders",
      "No Credit Card Fee – No 3% fee on any order",
      "Exclusive Products – Access to subscription-only items many",
  ...
  },
  {
    ...
    buttonColor: "#A8E654", // Rich Gold color
    benefits: [
      "Free Shipping – Included with subscription orders",
      "No Credit Card Fee – No 3% fee on any order",
  ...
  },
  {
    id: 3,
    tier: "Platinum Tier",
    facilities: "Platinum Tier : 5 boxes per month + 2 free boxes per quarter",
    buttonColor: "#379754", // Enhanced Platinum color (slightly darker)
    benefits: [
      "Free Shipping – Included with subscription orders",
      "No Credit Card Fee – No 3% fee on any order",
      "Exclusive Products – Access to subscription-only items",
  ...
  // Get the selected plan object based on the selectedPlanId
  const selectedPlan = subscriptionPlans.find(
    (plan) => plan.id === selectedPlanId
  );

  useEffect(() => {
    // Load selected plan ID from localStorage if exists
  ...
  // Function to render the icon for each plan
  ...
  return (
    <div>
      ...
      {/* Payment Modal as a separate component */}
      <PaymentModal
